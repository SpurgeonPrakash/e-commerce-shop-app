  ...
  User.findOne({ email: email })
    .then((user) => {
      if (user) {
        req.flash(
          "error",
          "A User with this email already exists. Please use different one!"
        );
...
exports.postReset = (req, res, next) => {
  crypto.randomBytes(32, (err, buffer) => {
    ...
    User.findOne({ email: req.body.email })
      .then((user) => {
        if (!user) {
          req.flash("error", "User with this email address do not exists!");
          return res.redirect("/reset");
        }
      ...
      .then((result) => {
        ...
        transporter.sendMail({
          ...
          html: `
        <p>You Requested Password Reseet</p>
